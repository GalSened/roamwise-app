 ...
 */ (function (Go, _n) {
  (function (l, ue) {
    ...
    var Ye = 0;
    function x(t) {
      return ('_leaflet_id' in t || (t._leaflet_id = ++Ye), t._leaflet_id);
    }
    function Xe(t, e, i) {
      var n, o, s, r;
      return (
    ...
    var mn = /\{ *([\w_ -]+) *\}/g;
    function $e(t, e) {
      return t.replace(mn, function (i, n) {
        var o = e[n];
    ...
    function ti(t) {
      ...
      return ((Qe = e + i), window.setTimeout(t, i));
    }
    var de = window.requestAnimationFrame || fe('RequestAnimationFrame') || ti,
      ei =
    ...
    ((it.extend = function (t) {
      ...
      return (
        ...
        t.includes && (vn(t.includes), b.apply(null, [n].concat(t.includes))),
        b(n, t),
        delete n.statics,
        delete n.includes,
        n.options && ((n.options = i.options ? Wt(i.options) : {}), b(n.options, t.options)),
        (n._initHooks = []),
    ...
    z.prototype = {
      ...
      equals: function (t) {
        return t
          ? ((t = H(t)), this.min.equals(t.getTopLeft()) && this.max.equals(t.getBottomRight()))
          : !1;
      },
    };
    function H(t, e) {
    ...
    F.prototype = {
      ...
      contains: function (t) {
        ...
        var e = this._southWest,
          ...
          o;
        return (
          t instanceof F ? ((n = t.getSouthWest()), (o = t.getNorthEast())) : (n = o = t),
    ...
    var ve = document.documentElement.style,
      ...
      yn = Gt && !document.addEventListener,
      ri = 'msLaunchUri' in navigator && !('documentMode' in document),
      ge = $('webkit'),
      ai = $('android'),
      hi = $('android 2') || $('android 3'),
      wn = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
      xn = ai && $('Google') && wn < 537 && !('AudioNode' in window),
      ye = !!window.opera,
      ui = !ri && $('chrome'),
      li = $('gecko') && !ge && !ye && !Gt,
      Pn = !ui && $('safari'),
      ci = $('phantom'),
      fi = 'OTransition' in ve,
      Ln = navigator.platform.indexOf('Win') === 0,
      di = Gt && 'transition' in ve,
      we = 'WebKitCSSMatrix' in window && 'm11' in new window.WebKitCSSMatrix() && !hi,
      _i = 'MozPerspective' in ve,
      Tn = !window.L_DISABLE_3D && (di || we || _i) && !fi && !ci,
      zt = typeof orientation < 'u' || $('mobile'),
      bn = zt && ge,
      Mn = zt && we,
      mi = !window.PointerEvent && window.MSPointerEvent,
      pi = !!(window.PointerEvent || mi),
      vi = 'ontouchstart' in window || !!window.TouchEvent,
      Cn = !window.L_NO_TOUCH && (vi || pi),
      Sn = zt && ye,
      zn = zt && li,
      kn = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1,
      En = (function () {
        var t = !1;
        try {
      ...
      xe = !!(document.createElementNS && oi('svg').createSVGRect),
      On =
        !!xe &&
        (function () {
      ...
      Bn = navigator.platform.indexOf('Linux') === 0;
    function $(t) {
    ...
    var f = {
      ...
      gi = f.msPointer ? 'MSPointerDown' : 'pointerdown',
      yi = f.msPointer ? 'MSPointerMove' : 'pointermove',
      wi = f.msPointer ? 'MSPointerUp' : 'pointerup',
      xi = f.msPointer ? 'MSPointerCancel' : 'pointercancel',
      Pe = { touchstart: gi, touchmove: yi, touchend: wi, touchcancel: xi },
      Pi = { touchstart: Wn, touchmove: Vt, touchend: Vt, touchcancel: Vt },
      vt = {},
      Li = !1;
    function Nn(t, e, i) {
      return (
        e === 'touchstart' && Fn(),
        Pi[e]
          ? ((i = Pi[e].bind(this, i)), t.addEventListener(Pe[e], i, !1), i)
    ...
    function Fn() {
      Li ||
        (document.addEventListener(gi, Dn, !0),
        document.addEventListener(yi, Hn, !0),
        document.addEventListener(wi, Ti, !0),
        document.addEventListener(xi, Ti, !0),
        (Li = !0));
    }
    function Vt(t, e) {
    ...
    function Wn(t, e) {
      (e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && N(e), Vt(t, e));
    }
    function Un(t) {
      var e = {},
        i,
    ...
    var Le = Kt(['transform', 'webkitTransform', 'OTransform', 'MozTransform', 'msTransform']),
      kt = Kt(['webkitTransition', 'transition', 'OTransition', 'MozTransition', 'msTransition']),
      bi = kt === 'webkitTransition' || kt === 'OTransition' ? kt + 'End' : 'transitionend';
    function Mi(t) {
    ...
    function I(t, e) {
      ((t._leaflet_pos = e),
        f.any3d ? ft(t, e) : ((t.style.left = e.x + 'px'), (t.style.top = e.y + 'px')));
    }
    function dt(t) {
    ...
    function Xt() {
      Yt && ((Yt.style.outlineStyle = ze), (Yt = void 0), (ze = void 0), M(window, 'keydown', Xt));
    }
    function Ci(t) {
      do t = t.parentNode;
    ...
    function M(t, e, i, n) {
      if (arguments.length === 1) (Si(t), delete t[Q]);
        ...
        : f.touch && e === 'dblclick'
          ...
          : 'addEventListener' in t
            ? e === 'touchstart' || e === 'touchmove' || e === 'wheel' || e === 'mousewheel'
              ? t.addEventListener(Ze[e] || e, s, f.passiveEvents ? { passive: !1 } : !1)
      ...
      w = Ct.extend({
        ...
        initialize: function (t, e) {
          ((e = S(this, e)),
            ...
            this.callInitHooks(),
            (this._zoomAnimated = kt && f.any3d && !f.mobileOpera && this.options.zoomAnimation),
            this._zoomAnimated &&
              (this._createAnimProxy(), p(this._proxy, bi, this._catchTransitionEnd, this)),
        ...
        flyTo: function (t, e, i) {
          ...
          function g(A) {
            var he = A ? -1 : 1,
              Do = A ? h : a,
              Ho = h * h - a * a + he * d * d * u * u,
              Fo = 2 * Do * d * u,
              je = Ho / Fo,
              dn = Math.sqrt(je * je + 1) - je,
              Wo = dn < 1e-9 ? -18 : Math.log(dn);
            return Wo;
          }
          function R(A) {
          ...
          var No = Date.now(),
            cn = (g(1) - W) / c,
            Ro = i.duration ? 1e3 * i.duration : 1e3 * cn * 0.8;
          function fn() {
            var A = (Date.now() - No) / Ro,
              he = Bo(A) * cn;
            A <= 1
              ? ((this._flyToFrame = D(fn, this)),
                this._move(
                  this.unproject(n.add(o.subtract(n).multiplyBy(Ao(he) / u)), r),
                  this.getScaleZoom(a / bt(he), r),
                  { flyTo: !0 }
                ))
              : this._move(t, e)._moveEnd(!0);
          }
          return (this._moveStart(!0, i.noMoveStart), fn.call(this), this);
        },
            ...
            for (r = 0; r < o.length; r++)
              if (
                ...
                h.originalEvent._stopped ||
                  (o[r].options.bubblingMouseEvents === !1 && ce(this._mouseEvents, e) !== -1))
              )
                return;
          }
        },
        ...
        _getBoundsOffset: function (t, e, i) {
          var n = H(this.project(e.getNorthEast(), i), this.project(e.getSouthWest(), i)),
    ...
    w.include({
      ...
      _initControlPos: function () {
        var t = (this._controlCorners = {}),
          e = 'leaflet-',
          i = (this._controlContainer = P('div', e + 'control-container', this._container));
        function n(o, s) {
          var r = e + o + ' ' + e + s;
          t[o + s] = P('div', r, i);
        }
    ...
    var Oi = Y.extend({
        ...
        _getLayer: function (t) {
          for (var e = 0; e < this._layers.length; e++)
            if (this._layers[e] && x(this._layers[e].layer) === t) return this._layers[e];
        },
        ...
        _updateDisabled: function () {
          ...
          (Z(this._zoomInButton, e),
            ...
            (this._disabled || t._zoom === t.getMaxZoom()) &&
              (v(this._zoomInButton, e), this._zoomInButton.setAttribute('aria-disabled', 'true')));
        },
      });
    ...
    var no = { Events: U },
      Ai = f.touch ? 'touchstart mousedown' : 'mousedown',
      ut = Ct.extend({
        ...
        enable: function () {
          this._enabled || (p(this._dragStartTarget, Ai, this._onDown, this), (this._enabled = !0));
        },
        disable: function () {
          this._enabled &&
            (ut._dragging === this && this.finishDrag(!0),
            M(this._dragStartTarget, Ai, this._onDown, this),
            (this._enabled = !1),
            (this._moved = !1));
        },
        _onDown: function (t) {
          if (this._enabled && ((this._moved = !1), !Te(this._element, 'leaflet-zoom-anim'))) {
            ...
            if (
              !(ut._dragging || t.shiftKey || (t.which !== 1 && t.button !== 1 && !t.touches)) &&
              ((ut._dragging = this),
      ...
      for (a = 0; a < 4; a++) {
        for (d = o[a], n = [], s = 0, c = t.length, r = c - 1; s < c; r = s++)
          ((h = t[s]),
            (u = t[r]),
            h._code & d
              ? u._code & d || ((g = Jt(u, h, d, e, i)), (g._code = pt(g, e)), n.push(g))
              : (u._code & d && ((g = Jt(u, h, d, e, i)), (g._code = pt(g, e)), n.push(g)),
                n.push(h)));
        t = n;
      }
    ...
    var oo = { __proto__: null, clipPolygon: Bi, polygonCenter: Ni, centroid: De };
    function Ri(t, e) {
    ...
    var uo = {
      ...
      lo = { __proto__: null, LonLat: Fe, Mercator: We, SphericalMercator: _e },
      co = b({}, ht, {
        code: 'EPSG:3395',
        projection: We,
        transformation: (function () {
    ...
    var wt = X.extend({
      ...
      xt = it.extend({
        ...
        _setIconStyles: function (t, e) {
          ...
          var o = _(n),
            s = _((e === 'shadow' && i.shadowAnchor) || i.iconAnchor || (o && o.divideBy(2, !0)));
    ...
    var Rt = xt.extend({
        ...
        _getIconUrl: function (t) {
          return (
            typeof Rt.imagePath != 'string' && (Rt.imagePath = this._detectIconPath()),
            (this.options.imagePath || Rt.imagePath) + xt.prototype._getIconUrl.call(this, t)
          );
        },
      ...
      $t = X.extend({
        ...
        _initInteraction: function () {
          if (
            ...
            (v(this._icon, 'leaflet-interactive'), this.addInteractiveTarget(this._icon), Vi)
          ) {
    ...
    var st = lt.extend({
      ...
      closestLayerPoint: function (t) {
        for (var e = 1 / 0, i = null, n = Nt, o, s, r = 0, a = this._parts.length; r < a; r++)
      ...
      _containsPoint: function (t, e) {
        ...
        for (i = 0, s = this._parts.length; i < s; i++)
          for (a = this._parts[i], n = 0, r = a.length, o = r - 1; n < r; o = n++)
            if (!(!e && n === 0) && Di(t, a[o], a[n]) <= h) return !0;
        return !1;
      },
    });
    function wo(t, e) {
      ...
      _clipPoints: function () {
        ...
        if (
          ...
          for (var n = 0, o = this._rings.length, s; n < o; n++)
            ((s = Bi(this._rings[n], t, !0)), s.length && this._parts.push(s));
        }
      },
      _updatePath: function () {
    ...
    function te(t, e) {
      ...
      switch (i.type) {
        case 'Point':
          return ((a = r(n)), qi(s, t, a, e));
        case 'MultiPoint':
          for (u = 0, c = n.length; u < c; u++) ((a = r(n[u])), o.push(qi(s, t, a, e)));
          return new ot(o);
        case 'LineString':
        ...
        case 'GeometryCollection':
          for (u = 0, c = i.geometries.length; u < c; u++) {
            var d = te({ geometry: i.geometries[u], type: 'Feature', properties: t.properties }, e);
            d && o.push(d);
          }
          return new ot(o);
    ...
    function Ve(t, e) {
      return (
        (t = y(t)),
        t.alt !== void 0 ? [J(t.lng, e), J(t.lat, e), J(t.alt, e)] : [J(t.lng, e), J(t.lat, e)]
      );
    }
    function ie(t, e, i, n) {
    ...
    ($t.include(qe),
      ...
      st.include({
        toGeoJSON: function (t) {
          ...
          return Lt(this, { type: (e ? 'Multi' : '') + 'LineString', coordinates: i });
        },
      }),
      Pt.include({
        toGeoJSON: function (t) {
      ...
      getEvents: function () {
        ...
        return (
          this.options.updateWhenIdle ||
            (this._onMove ||
              (this._onMove = Xe(this._onMoveEnd, this.options.updateInterval, this)),
            (t.move = this._onMove)),
      ...
      _updateLevels: function () {
        ...
        if (t !== void 0) {
          ...
          return (
            n ||
              ((n = this._levels[t] = {}),
              (n.el = P('div', 'leaflet-tile-container leaflet-zoom-animated', this._container)),
              (n.el.style.zIndex = e),
        ...
        ((i = this._tiles[n]),
          i &&
            ...
            this._map._fadeAnimated
              ? (V(i.el, 0), G(this._fadeFrame), (this._fadeFrame = D(this._updateOpacity, this)))
              : ((i.active = !0), this._pruneTiles()),
            e || (v(i.el, 'leaflet-tile-loaded'), this.fire('tileload', { tile: i.el, coords: t })),
            this._noTilesToLoad() &&
              ((this._loading = !1),
              this.fire('load'),
    ...
    var Tt = Dt.extend({
      ...
      _removeTile: function (t) {
        var e = this._tiles[t];
        if (e) return (e.el.setAttribute('src', Ut), Dt.prototype._removeTile.call(this, t));
      },
      _tileReady: function (t, e, i) {
    ...
    var $i = Tt.extend({
      ...
      getTileUrl: function (t) {
        ...
        return (
          a +
          Je(this.wmsParams, a, this.options.uppercase) +
    ...
    var at = X.extend({
        ...
        onAdd: function () {
          (this._container || (this._initContainer(), v(this._container, 'leaflet-zoom-animated')),
            this.getPane().appendChild(this._container),
            this._update(),
    ...
    f.vml && Ft.include(Eo);
    function en(t) {
      return f.svg || f.vml ? new Ft(t) : null;
    }
    w.include({
    ...
    (w.addInitHook('addHandler', 'doubleClickZoom', sn),
      w.mergeOptions({
        dragging: !0,
        inertia: !0,
    ...
    (w.addInitHook('addHandler', 'dragging', rn),
    ...
    (w.addInitHook('addHandler', 'keyboard', an),
    ...
    (w.addInitHook('addHandler', 'tapHold', un),
    ...
    (w.addInitHook('addHandler', 'touchZoom', ln),
      (w.BoxZoom = on),
      (w.DoubleClickZoom = sn),
      (w.Drag = rn),
      (w.Keyboard = an),
      (w.ScrollWheelZoom = hn),
      (w.TapHold = un),
      (w.TouchZoom = ln),
      (l.Bounds = z),
      (l.Browser = f),
...
var Vo = Ke.exports;
export { Vo as l };
//# sourceMappingURL=vendor-CyG76CEV.js.map

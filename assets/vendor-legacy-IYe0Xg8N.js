    ...
    execute: function () {
      ...
      (!(function (t, i) {
        !(function (t) {
              ...
              if (this._events && (n = this._events[t]))
                if (1 !== arguments.length)
                  if ('function' == typeof i) {
                    ...
                    if (!1 !== r) {
                      var a = n[r];
                      (this._firingCount && ((a.fn = l), (this._events[t] = n = n.slice())),
                        n.splice(r, 1));
                    }
                  } else console.warn('wrong listener type: ' + typeof i);
                else {
                  if (this._firingCount) for (o = 0, s = n.length; o < s; o++) n[o].fn = l;
          ...
          function Kt(t, i, e) {
            Ft[i] ? t.removeEventListener(Ft[i], e, !1) : console.warn('wrong event specified:', i);
          }
          function Yt(t) {
            Vt[t.pointerId] = t;
          }
          ...
          var si,
            ...
            hi,
            li,
            ui = zi(['transform', 'webkitTransform', 'OTransform', 'MozTransform', 'msTransform']),
            ci = zi([
              'webkitTransition',
              'transition',
              'OTransition',
          ...
          function Zi(t, i) {
            ((t._leaflet_pos = i),
              Nt.any3d ? Ci(t, i) : ((t.style.left = i.x + 'px'), (t.style.top = i.y + 'px')));
          }
          function Si(t) {
              ...
              : Nt.touch && 'dblclick' === i
                ...
                : 'addEventListener' in t
                  ? 'touchstart' === i || 'touchmove' === i || 'wheel' === i || 'mousewheel' === i
                    ? t.addEventListener(Fi[i] || i, s, !!Nt.passiveEvents && { passive: !1 })
            ...
            oe = k.extend({
              ...
              initialize: function (t, i) {
                ((i = _(this, i)),
                  ...
                  this.callInitHooks(),
                  (this._zoomAnimated =
                    ci && Nt.any3d && !Nt.mobileOpera && this.options.zoomAnimation),
                  this._zoomAnimated &&
              ...
              flyTo: function (t, i, e) {
                ...
                function d(t) {
                  var i =
                      (h * h - a * a + (t ? -1 : 1) * c * c * l * l) / (2 * (t ? h : a) * c * l),
                    e = Math.sqrt(i * i + 1) - i;
                ...
                function P() {
                  ...
                  e <= 1
                    ? ((this._flyToFrame = M(P, this)),
                      this._move(
                        this.unproject(n.add(o.subtract(n).multiplyBy(v(s) / l)), r),
          ...
          var ve = { Events: E },
            ...
            xe = k.extend({
              ...
              enable: function () {
                this._enabled ||
                  (Di(this._dragStartTarget, ye, this._onDown, this), (this._enabled = !0));
              },
              disable: function () {
                this._enabled &&
              ...
              _updatePosition: function () {
                ...
                (this.fire('predrag', t), Zi(this._element, this._newPos), this.fire('drag', t));
              },
              _onUp: function () {
              ...
              finishDrag: function (t) {
                (bi(document.body, 'leaflet-dragging'),
                  this._lastTarget &&
                    (bi(this._lastTarget, 'leaflet-drag-target'), (this._lastTarget = null)),
            ...
            for (r = 0; r < 4; r++) {
              for (u = d[r], n = [], o = 0, s = (l = t.length) - 1; o < l; s = o++)
                ((a = t[o]),
                  (h = t[s]),
                  a._code & u
                    ? h._code & u || (((c = Oe(h, a, u, i, e))._code = Ae(c, i)), n.push(c))
                    : (h._code & u && (((c = Oe(h, a, u, i, e))._code = Ae(c, i)), n.push(c)),
                      n.push(a)));
              t = n;
            }
          ...
          function De(t, i) {
            ...
            for (e = 0; e < d; e++) {
              var p = H(t[e]);
              _.push(i.project(H([p.lat - u.lat, p.lng - u.lng])));
            }
          ...
          var je = {
            ...
            Fe = { __proto__: null, LonLat: He, Mercator: We, SphericalMercator: q },
            Ue = e({}, U, {
              code: 'EPSG:3395',
              projection: We,
              transformation: (function () {
          ...
          function mn(t, i) {
            ...
            switch (r.type) {
              ...
              case 'MultiPoint':
                for (o = 0, s = a.length; o < s; o++) ((e = u(a[o])), h.push(fn(l, t, e, i)));
                return new Xe(h);
              case 'LineString':
              case 'MultiLineString':
                return ((n = vn(a, 'LineString' === r.type ? 0 : 1, u)), new un(n, i));
              case 'Polygon':
              case 'MultiPolygon':
                return ((n = vn(a, 'Polygon' === r.type ? 1 : 2, u)), new dn(n, i));
            ...
            Mn = Ge.extend({
              ...
              _reset: function () {
                var t = this._image,
                  ...
                  e = i.getSize();
                (Zi(t, i.min), (t.style.width = e.x + 'px'), (t.style.height = e.y + 'px'));
              },
              _updateOpacity: function () {
            ...
            onRemove: function (t) {
              (t._fadeAnimated
                ? (Ti(this._container, 0),
                  (this._removeTimeout = setTimeout(o(fi, void 0, this._container), 200)))
                : fi(this._container),
                this.options.interactive &&
            ...
            _abortLoading: function () {
              ...
              for (t in this._tiles)
                if (
                  ...
                  (((i = this._tiles[t].el).onload = l), (i.onerror = l), !i.complete)
                ) {
                  i.src = y;
          ...
          var Vn = Ge.extend({
              ...
              onAdd: function () {
                (this._container ||
                  (this._initContainer(), wi(this._container, 'leaflet-zoom-animated')),
                  this.getPane().appendChild(this._container),
                  this._update(),
...
//# sourceMappingURL=vendor-legacy-IYe0Xg8N.js.map
